...
def train_drm_model(db_path, 
    ...
    for epoch in range(epochs):
        ...
        for batch_idx, (x, c, y, v_true) in enumerate(train_loader):
            ...
            try:
                # Forward pass
                _, s_y, s_y_pred, v_pred = model(x, c, y, v_true)
                ...
                # Calculate loss
                total_loss, state_loss, value_loss = loss_fn(s_y, s_y_pred, v_true, v_pred)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_dir', type=str, default='neural_network/output', help='Directory to save outputs')
    ...
    parser.add_argument('--num_states', type=int, default=8, help='Number of discrete states')
...
# python -m neural_networks.train_drm datasets/results/tech_toy.db --output_dir=./neural_networks/output